...
class: $(TOOLS) $(SOURCE) $(EXTERNAL) $(OUTPUT) $(CLASS)
	$(CC) $(OPTFLAG) $(OMPFLAG) $(LDFLAG) $(GSL_LIBS) -lgsl -lgslcblas  -o class $(addprefix build/,$(notdir $^)) -lm

test_sigma: $(TOOLS) $(SOURCE) $(EXTERNAL) $(OUTPUT) $(TEST_SIGMA)
	$(CC) $(OPTFLAG) $(OMPFLAG) $(LDFLAG) $(GSL_LIBS) -lgsl -lgslcblas  -o test_sigma $(addprefix build/,$(notdir $^)) -lm

test_loops: $(TOOLS) $(SOURCE) $(EXTERNAL) $(OUTPUT) $(TEST_LOOPS)
	$(CC) $(OPTFLAG) $(OMPFLAG) $(LDFLAG) $(GSL_LIBS) -lgsl -lgslcblas -o $@ $(addprefix build/,$(notdir $^)) -lm
...
test_hyperspherical: $(TOOLS) $(TEST_HYPERSPHERICAL)
	$(CC) $(OPTFLAG) $(OMPFLAG) $(LDFLAG) $(GSL_LIBS) -lgsl -lgslcblas -o test_hyperspherical $(addprefix build/,$(notdir $^)) -lm
